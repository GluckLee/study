...
class GoogLeNet(paddle.nn.Layer):
    ...
    def forward(self, x):
        ...
        print((self.block3_1(x)).shape, (self.block3_2(self.block3_1(x))).shape)
        x = self.pool3(self.block3_2(self.block3_1(x)))
        print(x.shape)

        print((self.block4_1(x)).shape, (self.block4_2(self.block4_1(x))).shape)
        x = self.block4_3(self.block4_2(self.block4_1(x)))
        print(x.shape)

        print((self.block4_4(x)).shape, (self.block4_5(self.block4_4(x))).shape)
        x = self.pool4(self.block4_5(self.block4_4(x)))
        print(x.shape)

        print((self.block5_1(x)).shape, (self.block5_2(self.block5_1(x))).shape)
